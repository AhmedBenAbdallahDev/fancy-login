...
const FALLBACK_LOCAL_IMAGE = "/characters/tex_support_card_20037.png";
...
function GalleryScene({
  ...
  if (!textures?.length || normalizedImages.length === 0) {
    return null;
  }
  ...
  return (
    <>
      {planesData.current.map((plane, i) => {
        ...
        const imageMeta = texture.image as
          | { width?: number; height?: number }
          | undefined;
        const width =
          typeof imageMeta?.width === "number" ? imageMeta.width : 1;
        const height =
          typeof imageMeta?.height === "number" && imageMeta.height !== 0
            ? imageMeta.height
            : 1;
        ...
        {normalizedImages.map((img, i) => (
          <Image
            ...
            src={
              ...
              "/characters/tex_support_card_20037.png"
            }
